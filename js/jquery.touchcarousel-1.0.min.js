...
(function($) {
	function TouchCarousel(element, options) {	
		...
		this._CarouselImg = this.carouselRoot.find(".carousel-img");	
		...
		if(this.settings.directionNav) {	
			this._CarouselImg.after("<a href='#' class='arrow-holder left'><span class='arrow-icon left'></span></a> <a href='#' class='arrow-holder right'><span class='arrow-icon right'></span></a>");
	...
	$.fn.touchCarousel.defaults = {  
			...
			autoplayDelay:500,	          // Delay between transitions	
